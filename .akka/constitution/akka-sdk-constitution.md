...
- Templates requiring updates:
  - .akka/templates/plan.md — ✅ compatible (Constitution Check section aligns)
  - .akka/templates/spec.md — ✅ compatible
  - .akka/templates/tasks.md — ✅ compatible
...
### V. No AI Attribution (NON-NEGOTIABLE)

AI tooling assistance MUST NOT be attributed anywhere in version control
artifacts.

- Commit messages MUST NOT contain references to AI assistants, AI tools,
  or AI-generated content (e.g. "Claude", "Claude Code", "Generated with",
  "Co-Authored-By: Claude", or similar).
- Pull request titles and bodies MUST NOT contain such references.
- This applies to descriptive text, trailers, footers, and links alike.
- Authored content is the contributor's; it is presented without AI
  attribution.
...
**Version**: 1.1.0 | **Ratified**: 2026-03-05 | **Last Amended**: 2026-05-22
